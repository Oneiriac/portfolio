...
export const ProjectLink = React.forwardRef<HTMLAnchorElement, Props>(
  ({ className, linkType, children, ...props }, ref) => (
    <a ref={ref} className={`link-base link-${linkType}`} {...props}>
      <style jsx>{`
        a,
        a:visited {
